...
use Omnipay\YooMoney\Request\ReceiptListRequest;

/**
 * YooMoney
 */
class ReceiptListRequestTest extends TestCase
{
    /**
     * @var ReceiptListRequest
     */
    private $request;
    ...
    {
        $this->request = new ReceiptListRequest($this->getHttpClient(), $this->getHttpRequest());
    }
